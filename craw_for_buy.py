...
def process_one_page_buy(url):

    req = urllib2.Request(url)

    csvfile = file('munich_buy.csv', 'ab+')
    ...
    for tag in soup.find_all(name="li", attrs={"class": re.compile("result-list__listing result-list__listing--xl")}):
...
#
#     process_one_page_buy(url)
#     print "page %d scanned." % page

page = 1
url = r"https://www.immobilienscout24.de/Suche/S-T/P-%d/Wohnung-Kauf/Umkreissuche/M_fcnchen_20_28Kreis_29/-/118984/2024595/-/1276002060/20" % page
url = "https://www.immobilienscout24.de/Suche/S-T/Wohnung-Miete/Bayern/Muenchen-Kreis"
# process_one_page_buy(url)
